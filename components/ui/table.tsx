...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "[&_tr]:border-b bg-muted/30 dark:bg-muted/50 [&_tr]:border-border/50",
        className
      )}
      {...props}
    />
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "hover:bg-primary/5 dark:hover:bg-muted/50 hover:shadow-sm",
        "data-[state=selected]:bg-primary/10 dark:data-[state=selected]:bg-muted",
        "group",
        className
      )}
      {...props}
