...
export function DashboardContent({ variant = "overview" }: DashboardContentProps) {
  ...
  return (
    <PageContainer
      ...
      description={`Welcome to your ${variant === "technician" ? "technician" : user?.role?.toLowerCase() || 'user'} dashboard`}
      actions={getHeaderActions()}
    >
      <div className={variant === "overview" ? "grid gap-8 lg:grid-cols-[1fr_320px]" : ""}>
        {/* Main Content */}
