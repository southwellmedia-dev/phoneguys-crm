-- Fix timeline functions to use correct customer name column

-- Drop and recreate get_ticket_timeline with correct customer name column
...
BEGIN
  ...
  FROM (
    ...
    SELECT 
      ...
      CASE 
        WHEN c.visibility = 'customer' THEN v_customer_name
...
-- Drop and recreate get_appointment_timeline with correct customer name column
