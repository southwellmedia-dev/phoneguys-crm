-- Fix average completion time to use actual logged time, not elapsed calendar time
-- This is more accurate as tickets may wait for parts, approvals, etc.
...
BEGIN
    ...
    SET
        ...
        -- This gives us the average hands-on time per completed ticket
        avg_completion_time_hours = (
            SELECT AVG(total_time_minutes / 60.0)::DECIMAL(10,2)
